		...
		<section className="flex flex-col w-full items-center justify-center gap-6 mt-14">
			...
			<div className="text-center text-balance flex flex-col items-center gap-6">
				<BoxFadeIn className="inline">
					<h1 className="inline font-bold lg:text-7xl md:text-5xl text-3xl leading-none tracking-tighter text-transparent bg-gradient-to-br from-foreground from-65% to-accent bg-clip-text py-6">
						{dict?.hero?.title}
					</h1>

					<SparklesText
						sparklesCount={3}
						text={dict?.hero?.["title-highlight"]}
						className="inline lg:text-6xl md:text-4xl text-2xl text-accent-foreground"
					/>
				</BoxFadeIn>
			...
			<BoxFadeIn className="flex justify-center" delay={1}>
				<Button className="group sm:mt-12">
